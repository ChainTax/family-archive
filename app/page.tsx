    ...
    <div className="min-h-screen flex flex-col bg-bg-primary">
      ...
      <header className="sticky top-0 z-40 bg-bg-primary/90 backdrop-blur-md border-b border-border-default">
        <nav className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 text-xl font-bold text-text-primary hover:text-brand transition-colors">
            <img src="/logo.png" alt="" className="w-8 h-8 object-contain mix-blend-multiply" />
            재린월드
          </Link>
          <div className="flex items-center gap-3 sm:gap-6">
            <Link href="/blog" className="text-sm sm:text-base text-text-secondary hover:text-text-primary transition-colors">기록</Link>
            <Link href="/albums" className="text-sm sm:text-base text-text-secondary hover:text-text-primary transition-colors">앨범</Link>
            <Link href="/milestones" className="text-sm sm:text-base text-text-secondary hover:text-text-primary transition-colors">마일스톤</Link>
            <Link href="/growth" className="text-sm sm:text-base text-text-secondary hover:text-text-primary transition-colors">성장</Link>
            <Link href="/search" aria-label="검색" className="flex items-center justify-center w-7 h-7 sm:w-8 sm:h-8 text-text-secondary hover:text-text-primary transition-colors">
            ...
            {session && (
              <Link href="/admin" className="text-sm sm:text-base font-semibold text-brand hover:text-brand-hover transition-colors">관리자</Link>
            )}
          </div>
        </nav>
      </header>
